...
// 1. 导入解耦的 UI 组件
import { CustomBrandMark, CustomBrandName, HeroSlotAutoHider, brandingManager } from './components/BrandBranding'
...
import { MarketplaceAgentsTab, MarketplaceSkillsTab, MarketplaceCommunityPluginsTab } from './pages/MarketplaceSection'
    ...
    ctx.slots.inject('sidebar.brand.name', () =>
      ctx.slots.inject('conversation.hero.brand.mark', function* () {
        ...
        yield ctx.slots.register({
          ...
          priority: -100
        }, (props: any) => React.createElement(CustomBrandMark, { size: props?.size || 24 }))
