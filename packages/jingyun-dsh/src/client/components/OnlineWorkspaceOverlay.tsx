...
export function OnlineWorkspaceOverlay() {
  ...
  React.useEffect(() => {
    const locateTarget = () => {
      ...
      if (mainEl) {
        ...
        const chatWrapper = document.querySelector('[class*="chatWrapper"]') || 
  ...
  const isOverlayActive = currentHash.startsWith('#/jingyun/more') || 
        ...
        setTimeout(() => {
          ...
          const emitAgent = () => {
            if (typeof window !== 'undefined') {
              ...
              try {
                const activeSessionEl = document.querySelector('[class*="sessionItem"][class*="active"]') ||
                  document.querySelector('[class*="active"]')
                if (activeSessionEl) {
                  const sessId = activeSessionEl.getAttribute('data-session-id') || 
                    activeSessionEl.id || 
                    'default'
